# -*- coding: utf-8 -*-
"""
Created on Wed Feb 6 14:49:50 2019
...
def get_predictions():
    ...
    test.to_csv('predictions_Xception.csv', encoding='utf-8', index=True)
...
def main():
    ...
    checkpoint = ModelCheckpoint("./Xception_checkpoints/model-1-.{epoch:02d}-{val_loss:.4f}-.hdf5", monitor="val_loss", verbose=1, save_best_only=True,
    ...
    ## Delete the Xception_checkpoints directory
#    try
#        shutil.rmtree('Xception_checkpoints')
#    except OSError as e:
